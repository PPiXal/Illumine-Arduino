...
4. Upload the Arduino code `(mainController.ino)` to the **Arduino Uno R3** using the **Arduino IDE**.

5. Upload the ESP8266 code `(accessPoint.ino)` to the **Generic ESP8266 WiFi** using the **Arduino IDE**.
